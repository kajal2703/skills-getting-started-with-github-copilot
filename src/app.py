...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team for competitive play",
    ...
    "Debate Club": {
        ...
        "max_participants": 14,
        "participants": ["alex_smith@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and explore scientific concepts",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["sam@mergington.edu", "pat@mergington.edu"]
    }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    #validate the student if already signed up
